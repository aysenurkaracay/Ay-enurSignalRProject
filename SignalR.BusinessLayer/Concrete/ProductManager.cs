...
namespace SignalR.BusinessLayer.Concrete
{
	public class ProductManager : IProductService
	{
        ...
        object? IProductService.TTotalPriceByDrinkCategory()
        {
            throw new NotImplementedException();
        }

        object? IProductService.TProductPriceBySteakBurger()
        {
            throw new NotImplementedException();
        }

        object? IProductService.TProductAvgPriceByHamburger()
        {
            throw new NotImplementedException();
        }

        object? IProductService.TTotalPriceBySaladCategory()
        {
            throw new NotImplementedException();
        }
    }
